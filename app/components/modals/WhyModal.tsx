...
export function WhyModal({ onClose }: { onClose: () => void }) {
  return (
    <div className="fixed inset-0 z-[100] flex items-center justify-center p-6 bg-[var(--color-background)] bg-opacity-90 backdrop-blur-md animate-fade-in">
      <div className="ag-card max-w-4xl w-full p-0 relative animate-scale-in border border-[var(--color-primary)] overflow-hidden">
        ...
        <div className="grid md:grid-cols-2">
          {/* Photo Section */}
          <div className="relative aspect-[4/5] md:aspect-auto h-full bg-[var(--color-surface-2)] border-r-2 border-[var(--color-primary)] min-h-[400px]">
            <Image
            ...
            <div className="absolute bottom-8 left-8 right-8">
              ...
              <p className="text-sm font-sans text-[var(--color-foreground)] tracking-widest uppercase opacity-80 font-bold">Student / Creator</p>
            </div>
          </div>
          ...
          <div className="p-10 space-y-8 bg-[var(--color-card)] relative">
            ...
            <div className="space-y-2">
              ...
              <h2 className="text-4xl font-black text-[var(--color-foreground)] tracking-tighter leading-none italic uppercase underline decoration-[var(--color-primary)] decoration-4 underline-offset-4">
                Transparency over Guesswork.
              </h2>
            </div>

            <div className="space-y-6 text-sm text-[var(--color-foreground)] leading-relaxed">
              <p className="font-bold text-lg text-[var(--color-primary-soft)]">
              ...
              <p className="opacity-80">
                ...
                <div className="p-4 border-l-2 border-[var(--color-primary)] bg-[var(--color-primary-tint)] font-sans text-[11px] leading-tight font-medium">
            ...
            <div className="pt-4 flex justify-between items-end">
              ...
              <button
                onClick={onClose}
                className="btn-zine !px-10 !py-3 tracking-widest"
              >
                Continue.
              </button>
            </div>
