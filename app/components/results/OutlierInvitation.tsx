  ...
  return (
    <div id="personal-invitation" className="ag-card p-8 animate-fade-in-up border-l-4 border-l-[var(--color-accent)] scroll-mt-8 shadow-2xl relative">
      <div className="flex items-center gap-3 mb-4">
        ...
        <h3 className="text-xl font-black font-sans text-[var(--color-foreground)] tracking-tight">Private Invitation</h3>
      </div>

      {themeInfo.message && (
        <div className="p-4 mb-6 border-l-2 border-[var(--color-primary)] bg-[var(--color-primary-tint)]">
      ...
      <div className="p-5 bg-[var(--color-card)] border-2 border-[var(--color-border)] mb-6">
      ...
      {accepted ? (
        <div className="space-y-4">
          <div className="text-center p-6 border border-[var(--color-success)] bg-[var(--color-success-tint)] border border-[var(--color-success)]/40 rounded-lg">
        ...
        <div className="space-y-3">
          ...
          />
          <textarea
            className="ag-input min-h-[120px] resize-none"
          ...
          <button
            ...
            className="btn-zine w-full !bg-white !text-black !border-black hover:!bg-[var(--color-primary)] disabled:opacity-30"
          >
